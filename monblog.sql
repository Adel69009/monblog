...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 24 Juillet 2018 à 05:22
...
(1, '2018-07-10 13:41:27', 'Premier billet', 'Bonjour monde ! Ceci est le premier billet sur mon blog.'),
(2, '2018-07-10 13:41:27', 'Au travail', 'Il faut enrichir ce blog dès maintenant.');
...
(1, '2018-07-10 13:41:27', 'A. Nonyme', 'Bravo pour ce début', 1),
(2, '2018-07-10 13:41:28', 'Moi', 'Merci ! Je vais continuer sur ma lancée', 1);
...
--
ALTER TABLE `t_commentaire`
  ADD CONSTRAINT `fk_com_bil` FOREIGN KEY (`BIL_ID`) REFERENCES `t_billet` (`BIL_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
